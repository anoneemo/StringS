...
on 1:JOIN:%sillaba_canale:{ if (%gamesillaba_stato != OFF) { .msg $nick 11,2  ©º°¨¨°º©'4,2 StringS running on %sillaba_canale 11,2   '©º°¨¨°º© 8,2 Type !help in channel for game rules } }
